...
In java script we discuss function very important 
...
* A unction definition (also called a function declaration, or function statement) consists of the function keyword, followed by:
...
## 16. What you've learned so far:

 * If an identifier is declared in global scope, it's available everywhere.
 * If an identifier is declared in function scope, it's available in the function it was declared in (even in functions declared inside the function).
 * When trying to access an identifier, the JavaScript Engine will first look in the current function. I* f it doesn't find anything, it will continue to the next outer function to see if it can find the                                                             identifier there. It will keep doing this until it reaches the global scope.
